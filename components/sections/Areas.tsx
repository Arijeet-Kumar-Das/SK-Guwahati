...
export default function Areas({ areas }: AreasProps) {
  return (
    <section id="areas" aria-label="Areas We Serve" className="py-24 lg:py-32 bg-navy-950 relative overflow-hidden">
      {/* Decorative */}
      ...
      <div className="section-container relative z-10">
        ...
        <FadeUp className="text-center mb-14">
          <p className="section-label text-brand-green-400">Service Coverage</p>
        ...
        <StaggerContainer className="flex flex-wrap justify-center gap-3 lg:gap-4 max-w-4xl mx-auto">
          {areas.map((area) => (
            <StaggerItem key={area._id}>
              <div className="group inline-flex items-center gap-2 bg-white/[0.06] hover:bg-white/[0.12] border border-white/[0.08] hover:border-brand-green-400/30 rounded-full px-5 py-2.5 transition-all duration-300 cursor-default">
                <MapPin
                  size={14}
